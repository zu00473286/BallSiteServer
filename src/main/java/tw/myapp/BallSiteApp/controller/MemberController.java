...
public class MemberController {
    ...
    // 處理 app 顯示會員資料請求      postman已測試
    @PostMapping("/memberAll")
    public Map<String, Object> memberAll(@RequestBody String body) {
        JSONObject object = new JSONObject(body);
        JSONObject data = object.getJSONObject("data");
    ...
    // 處理 app 會員租借紀錄請求      postman已測試
    @PostMapping("/rentRecord")
    public List<Map<String, Object>> rentRecord(@RequestBody String body) {
        JSONObject object = new JSONObject(body);
        JSONObject data = object.getJSONObject("data");
